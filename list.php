...
<body>
    <div class="navbar navbar-dark bg-dark active">
        <div class="container">
            <a href="#" class="navbar-brand active">CRUD APPLICATION</a>
    ...
    <div class="col-6"><a href="<?php echo base_url().'index.php/user/create';?>" class="btn btn-info bi bi-plus active">CREATE</a></div>
    </div>
        ...
        <div class="row">
            <div class="col-md-8">
                <table class="table table-striped">
                    ...
                    <?php $n = 1; if(!empty($users)) { foreach($users as $user) { ?>
